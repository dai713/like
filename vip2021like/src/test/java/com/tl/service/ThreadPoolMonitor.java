...
public class ThreadPoolMonitor extends ThreadPoolExecutor {
    ...
    public void shutdown() {
        System.out.printf("【任务结束】%s 线程池延迟关闭时. 统计已执行任务: %s, 正在执行任务: %s,未执行任务数量:%s \r\n",
    ...
    public List<Runnable> shutdownNow() {
        ...
        System.out.printf("【任务结束】%s Going to immediately shutdown. 统计已执行任务: %s, 正在执行任务: %s,未执行任务数量:%s \r\n",
                this.poolName, this.getCompletedTaskCount(), this.getActiveCount(), this.getQueue().size());
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        System.out.printf("【任务】{%s-pool-monitor: " +
                        "统计任务耗时: %s ms, 初始线程数: %s, 核心线程数: %s, 正在执行的任务数量: %s, " +
                        "已完成任务数量: %s, 任务总数: %s, 队列里缓存的任务数量: %s, 池中存在的最大线程数:%s, " +
                        "最大允许的线程数: %s,  线程空闲时间: %s, 线程池是否关闭:%s, 线程池是否终止: %s \r\n",
                this.poolName,
